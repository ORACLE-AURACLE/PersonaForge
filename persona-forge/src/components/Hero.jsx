  ...
  return (
    <section className="hero-container">
      ...
      <div className="hero-content">
        ...
        <p>Choose a realistic persona, test your idea, and understand why they react the way they do.</p>
        <button className="cta-button" onClick={() => navigate('/personas')}>Choose a Persona</button>
      </div>
