  ...
  return (
    <section className="persona-page">
      ...
      <div className="persona-grid">
        <div className="persona-card" onClick={()=> navigate('/personas/amaka')}>
          <h3>Amaka Okonkwo</h3>
          <span className="persona-meta">34 · Product Manager at B2B SaaS</span>
          <p>
        ...
        <div className="persona-card" onClick={()=> navigate('/personas/daniel')}>
          <h3>Daniel Chen</h3>
          <span className="persona-meta">28 · Indie Creator & Coder</span>
          <p>
            Runs a solo studio and ships fast. Focuses on speed, quality, and scalability.
          </p>
          <div className="persona-tags">
            <span>Creative</span>
        ...
        <div className="persona-card" onClick={()=> navigate('/personas/priya')}>
          <h3>Priya Sharma</h3>
          <span className="persona-meta">41 · UX Research Lead</span>
          <p>
            Leads research teams and translates insights into product strategy.
          </p>
          <div className="persona-tags">
        ...
        <div className="persona-card" onClick={()=> navigate('/personas/marcus')}>
